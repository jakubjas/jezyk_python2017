...
def compare_exec_time(i, j):
    ...
    print "Wartosc zwrocona przez P(" + str(i) + ", " + str(j) + "): " + \
          str(P_value) + " Czas wykonania: " + str(P_exec_time)
    print "Wartosc zwrocona przez P_dynamic(" + str(i) + ", " + str(j) + "): " + \
          str(P_dynamic_value) + " Czas wykonania: " + str(P_dynamic_exec_time)
